...
static asn_SET_OF_specifics_t asn_SPC_RRC_ra_OccasionList_specs_3 = {
	sizeof(struct RRC_CFRA_CSIRS_Resource__ra_OccasionList),
	offsetof(struct RRC_CFRA_CSIRS_Resource__ra_OccasionList, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_RRC_CFRA_CSIRS_Resource_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRC_CFRA_CSIRS_Resource, csi_RS),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRC_CFRA_CSIRS_Resource, ra_OccasionList),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRC_CFRA_CSIRS_Resource, ra_PreambleIndex),
...
static const ber_tlv_tag_t asn_DEF_RRC_CFRA_CSIRS_Resource_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_RRC_CFRA_CSIRS_Resource_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_RRC_CFRA_CSIRS_Resource_specs_1 = {
	sizeof(struct RRC_CFRA_CSIRS_Resource),
	offsetof(struct RRC_CFRA_CSIRS_Resource, _asn_ctx),
	asn_MAP_RRC_CFRA_CSIRS_Resource_tag2el_1,
	3,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	3,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_RRC_CFRA_CSIRS_Resource = {
	"CFRA-CSIRS-Resource",
	"CFRA-CSIRS-Resource",
	&asn_OP_SEQUENCE,
	asn_DEF_RRC_CFRA_CSIRS_Resource_tags_1,
	sizeof(asn_DEF_RRC_CFRA_CSIRS_Resource_tags_1)
		/sizeof(asn_DEF_RRC_CFRA_CSIRS_Resource_tags_1[0]), /* 1 */
	asn_DEF_RRC_CFRA_CSIRS_Resource_tags_1,	/* Same as above */
	sizeof(asn_DEF_RRC_CFRA_CSIRS_Resource_tags_1)
		/sizeof(asn_DEF_RRC_CFRA_CSIRS_Resource_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_RRC_CFRA_CSIRS_Resource_1,
	3,	/* Elements count */
	&asn_SPC_RRC_CFRA_CSIRS_Resource_specs_1	/* Additional specs */
};
