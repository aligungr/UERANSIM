...
asn_TYPE_member_t asn_MBR_RRC_SIB8_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRC_SIB8, messageIdentifier),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRC_SIB8, serialNumber),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRC_SIB8, warningMessageSegmentType),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRC_SIB8, warningMessageSegmentNumber),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRC_SIB8, warningMessageSegment),
	...
	{ ATF_POINTER, 3, offsetof(struct RRC_SIB8, dataCodingScheme),
	...
	{ ATF_POINTER, 2, offsetof(struct RRC_SIB8, warningAreaCoordinatesSegment),
	...
	{ ATF_POINTER, 1, offsetof(struct RRC_SIB8, lateNonCriticalExtension),
...
static const int asn_MAP_RRC_SIB8_oms_1[] = { 5, 6, 7 };
static const ber_tlv_tag_t asn_DEF_RRC_SIB8_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_RRC_SIB8_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_RRC_SIB8_specs_1 = {
	sizeof(struct RRC_SIB8),
	offsetof(struct RRC_SIB8, _asn_ctx),
	asn_MAP_RRC_SIB8_tag2el_1,
	8,	/* Count of tags in the map */
	asn_MAP_RRC_SIB8_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	8,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_RRC_SIB8 = {
	"SIB8",
	"SIB8",
	&asn_OP_SEQUENCE,
	asn_DEF_RRC_SIB8_tags_1,
	sizeof(asn_DEF_RRC_SIB8_tags_1)
		/sizeof(asn_DEF_RRC_SIB8_tags_1[0]), /* 1 */
	asn_DEF_RRC_SIB8_tags_1,	/* Same as above */
	sizeof(asn_DEF_RRC_SIB8_tags_1)
		/sizeof(asn_DEF_RRC_SIB8_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_RRC_SIB8_1,
	8,	/* Elements count */
	&asn_SPC_RRC_SIB8_specs_1	/* Additional specs */
};
