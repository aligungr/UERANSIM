...
extern "C" JNIEXPORT jbyteArray JNICALL Java_tr_havelsan_ueransim_rrc_RrcJni_convertEncoding(JNIEnv *pEnv, jclass cls, jbyteArray data, jint fromEncoding, jint toEncoding, jintArray result, jint pduType)
{
