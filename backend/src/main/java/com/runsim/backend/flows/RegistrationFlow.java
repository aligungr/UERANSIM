...
public class RegistrationFlow extends BaseFlow {
    ...
    public State main(Message message) throws Exception {
        var pdu = NGAP.perDecode(NGAP_PDU.class, "000f403f0000040055000200010026001a197e004171000d010011000000000000000000f12e04808080800079000f400001100000011000000110000075005a400118");

        var x = NGAP.xerEncode(pdu);
