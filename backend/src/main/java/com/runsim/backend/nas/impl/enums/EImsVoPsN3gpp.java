...
public class EImsVoPsN3gpp extends ProtocolEnum {
    public static final EImsVoPsN3gpp NOT_SUPPORTED
            = new EImsVoPsN3gpp(0b1, "IMS voice over PS session not supported over non-3GPP access");
    public static final EImsVoPsN3gpp SUPPORTED
            = new EImsVoPsN3gpp(0b0, "IMS voice over PS session supported over non-3GPP access");
