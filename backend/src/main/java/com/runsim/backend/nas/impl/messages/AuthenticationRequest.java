...
public class AuthenticationRequest extends PlainNasMessage {
    ...
    public AuthenticationRequest decodeMessage(OctetInputStream stream) {
        ...
        req.ngKSI = ProtocolDecoder.ie1(stream.readOctetI(), IENasKeySetIdentifier.class);
        req.abba = ProtocolDecoder.ie4(stream, false, IEAbba.class);
        ...
        while (stream.hasNext()) {
            ...
            switch (type) {
                ...
                case 0x78:
                    req.eap = ProtocolDecoder.eap(stream);
                    break;
                default:
