...
public class Test_EEA2_128 {

    @Test
    public void test1() {
        testForFile("crypto/testdata/eea2_128/test1.json");
    }

    @Test
    public void test2() {
        testForFile("crypto/testdata/eea2_128/test2.json");
    }

    @Test
    public void test3() {
        testForFile("crypto/testdata/eea2_128/test3.json");
    }

    @Test
    public void test4() {
        testForFile("crypto/testdata/eea2_128/test4.json");
    }

    @Test
    public void test5() {
        testForFile("crypto/testdata/eea2_128/test5.json");
    }

    @Test
    public void test6() {
        testForFile("crypto/testdata/eea2_128/test6.json");
    }
    ...
    private void testForFile(String testFile) {
        ...
        var result = EEA2_128.encrypt(count, bearer, direction, message, key);
        Assert.assertEquals(expected, result);
        Assert.assertEquals(message, EEA2_128.decrypt(count, bearer, direction, result, key));
    }
}
