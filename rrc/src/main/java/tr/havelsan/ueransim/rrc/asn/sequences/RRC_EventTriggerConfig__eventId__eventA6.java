...
public class RRC_EventTriggerConfig__eventId__eventA6 extends RRC_Sequence {

    public RRC_MeasTriggerQuantityOffset a6_Offset;
    ...
    public String[] getMemberNames() {
        return new String[]{ "a6-Offset","reportOnLeave","hysteresis","timeToTrigger","useWhiteCellList" };
    }
