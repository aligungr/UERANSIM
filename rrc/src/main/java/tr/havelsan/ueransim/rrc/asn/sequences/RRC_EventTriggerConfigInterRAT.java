...
import tr.havelsan.ueransim.rrc.asn.choices.RRC_EventTriggerConfigInterRAT__eventId;
...
public class RRC_EventTriggerConfigInterRAT extends RRC_Sequence {

    public RRC_EventTriggerConfigInterRAT__eventId eventId;
    ...
    public String[] getMemberNames() {
        return new String[]{ "eventId","rsType","reportInterval","reportAmount","reportQuantity","maxReportCells" };
    }
