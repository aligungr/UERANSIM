...
import tr.havelsan.ueransim.rrc.asn.choices.RRC_SecurityModeComplete__criticalExtensions;
import tr.havelsan.ueransim.rrc.asn.core.RRC_Sequence;
import tr.havelsan.ueransim.rrc.asn.integers.RRC_RRC_TransactionIdentifier;

public class RRC_SecurityModeComplete extends RRC_Sequence {

    public RRC_RRC_TransactionIdentifier rrc_TransactionIdentifier;
    public RRC_SecurityModeComplete__criticalExtensions criticalExtensions;
