...
public class RRC_PDCP_Config__drb__headerCompression__rohc extends RRC_Sequence {

    public RRC_Integer maxCID;
    public RRC_PDCP_Config__drb__headerCompression__rohc__profiles profiles;
