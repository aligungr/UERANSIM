...
public class RRC_MeasQuantityResults extends AsnSequence {
    public RRC_RSRP_Range rsrp; // optional
    public RRC_RSRQ_Range rsrq; // optional
    public RRC_SINR_Range sinr; // optional
}
