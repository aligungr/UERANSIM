...
public class RRC_SIB8 extends RRC_Sequence {
    ...
    public RRC_OctetString warningAreaCoordinatesSegment;
    public RRC_OctetString lateNonCriticalExtension;

    @Override
    public String[] getMemberNames() {
        return new String[]{ "messageIdentifier","serialNumber","warningMessageSegmentType","warningMessageSegmentNumber","warningMessageSegment","dataCodingScheme","warningAreaCoordinatesSegment","lateNonCriticalExtension" };
    }
