...
void UeRrcLayer::sendRrcMessage(int cellId, ASN_RRC_UL_CCCH_Message *msg)
{
    ...
    m_base->task->rlsCtl().handleUplinkRrcDelivery(cellId, 0, rrc::RrcChannel::UL_CCCH, std::move(pdu));
}
...
void UeRrcLayer::sendRrcMessage(int cellId, ASN_RRC_UL_CCCH1_Message *msg)
{
    ...
    m_base->task->rlsCtl().handleUplinkRrcDelivery(cellId, 0, rrc::RrcChannel::UL_CCCH1, std::move(pdu));
}
...
void UeRrcLayer::sendRrcMessage(ASN_RRC_UL_DCCH_Message *msg)
{
    ...
    m_base->task->rlsCtl().handleUplinkRrcDelivery(
