...
const char *EnumToString(ESmCause v)
{
    ...
    case ESmCause::NETWORK_FAILURE:
        return "NETWORK_FAILURE";
    case ESmCause::REACTIVATION_REQUESTED:
        return "REACTIVATION_REQUESTED";
    case ESmCause::SEMANTIC_ERROR_IN_THE_TFT_OPERATION:
        return "SEMANTIC_ERROR_IN_THE_TFT_OPERATION";
    case ESmCause::SYNTACTICAL_ERROR_IN_THE_TFT_OPERATION:
    ...
    case ESmCause::PDU_SESSION_TYPE_IPV4V6_ONLY_ALLOWED:
        return "PDU_SESSION_TYPE_IPV4V6_ONLY_ALLOWED";
    case ESmCause::PDU_SESSION_TYPE_UNSTRUCTURED_ONLY_ALLOWED:
        return "PDU_SESSION_TYPE_UNSTRUCTURED_ONLY_ALLOWED";
    case ESmCause::UNSUPPORTED_5QI_VALUE:
        return "UNSUPPORTED_5QI_VALUE";
    case ESmCause::PDU_SESSION_TYPE_ETHERNET_ONLY_ALLOWED:
        return "PDU_SESSION_TYPE_ETHERNET_ONLY_ALLOWED";
