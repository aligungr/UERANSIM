...
import tr.havelsan.ueransim.inputs.NgSetupRegistrationInput;
...
public class NgSetupRegistrationFlow extends BaseFlow {
    private final NgSetupRegistrationInput input;
    private final MilenageBufferFactory<BigIntegerBuffer> milenageBufferFactory;
    private long amfUeNgapId;

    public NgSetupRegistrationFlow(NgSetupRegistrationInput input) {
        this.input = input;
