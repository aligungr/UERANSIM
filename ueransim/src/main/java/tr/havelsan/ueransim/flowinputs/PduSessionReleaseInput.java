...
public class PduSessionReleaseInput {
    ...
    public PduSessionReleaseInput(long ranUeNgapId, UserLocationInformationNr userLocationInformationNr, Octet pduSessionId, Octet procedureTransactionId, IESNssai sNssai, IEDnn dnn) {
