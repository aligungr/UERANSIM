...
public class UeRegistration {
    ...
    public static void sendInitialRegistration(SimulationContext ctx, IESNssai[] requestNssai, int rrcEstablishmentCause) {
        ...
        registrationRequest.requestedNSSAI = new IENssai(requestNssai);
        ...
        Messaging.send(ctx, new SendingMessage(new NgapBuilder(NgapProcedure.InitialUEMessage, NgapCriticality.IGNORE)
                .addProtocolIE(new RRCEstablishmentCause(rrcEstablishmentCause), NgapCriticality.IGNORE), registrationRequest));
    }
