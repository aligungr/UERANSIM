...
public class NGAP_HandoverPreparationFailure extends NGAP_BaseMessage {

    public NGAP_HandoverPreparationFailure() {

    }

    @Override
    public NgapMessageType getMessageType() {
        return NgapMessageType.HandoverPreparationFailure;
    }

    @Override
    public NgapProtocolIeType getProtocolIeType() {
        return NgapProtocolIeType.forMessage("HandoverPreparationFailure");
    }
