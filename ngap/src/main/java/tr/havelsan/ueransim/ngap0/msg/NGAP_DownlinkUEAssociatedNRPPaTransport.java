...
public class NGAP_DownlinkUEAssociatedNRPPaTransport extends NGAP_BaseMessage {

    public NGAP_DownlinkUEAssociatedNRPPaTransport() {

    }

    @Override
    public NgapMessageType getMessageType() {
        return NgapMessageType.DownlinkUEAssociatedNRPPaTransport;
    }

    @Override
    public NgapProtocolIeType getProtocolIeType() {
        return NgapProtocolIeType.forMessage("DownlinkUEAssociatedNRPPaTransport");
    }
