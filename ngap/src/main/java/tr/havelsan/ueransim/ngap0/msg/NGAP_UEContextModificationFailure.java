...
public class NGAP_UEContextModificationFailure extends NGAP_BaseMessage {
    ...
    public NgapMessageType getMessageType() {
        return NgapMessageType.UEContextModificationFailure;
    }

    @Override
    public NgapProtocolIeType getProtocolIeType() {
        return NgapProtocolIeType.forMessage("UEContextModificationFailure");
    }
