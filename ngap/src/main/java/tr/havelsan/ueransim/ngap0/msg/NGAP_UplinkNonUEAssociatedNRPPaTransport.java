...
public class NGAP_UplinkNonUEAssociatedNRPPaTransport extends NGAP_BaseMessage {

    public NGAP_UplinkNonUEAssociatedNRPPaTransport() {

    }

    @Override
    public NgapMessageType getMessageType() {
        return NgapMessageType.UplinkNonUEAssociatedNRPPaTransport;
    }

    @Override
    public NgapProtocolIeType getProtocolIeType() {
        return NgapProtocolIeType.forMessage("UplinkNonUEAssociatedNRPPaTransport");
    }
