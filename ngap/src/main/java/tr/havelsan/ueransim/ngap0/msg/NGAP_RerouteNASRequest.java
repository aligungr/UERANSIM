...
import tr.havelsan.ueransim.ngap0.ies.sequences.NGAP_SourceToTarget_AMFInformationReroute;
...
public class NGAP_RerouteNASRequest extends NGAP_BaseMessage {
    ...
    public NgapProtocolIeType getProtocolIeType() {
        return NgapProtocolIeType.forMessage("RerouteNASRequest");
    }
    ...
    @Override
    public int[] getIeId() {
        return new int[] { 85, 10, 42, 3, 0, 171 };
    }
    ...
    public Class<? extends NGAP_Value>[] getIeTypes() {
        return new Class[] { NGAP_RAN_UE_NGAP_ID.class, NGAP_AMF_UE_NGAP_ID.class, NGAP_NGAP_Message.class, NGAP_AMFSetID.class, NGAP_AllowedNSSAI.class, NGAP_SourceToTarget_AMFInformationReroute.class };
    }

    @Override
    public int[] getIePresence() {
        return new int[] { 2, 0, 2, 2, 0, 0 };
    }
