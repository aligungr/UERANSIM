...
public class NGAP_RRCInactiveTransitionReport extends NGAP_BaseMessage {
    ...
    public NgapMessageType getMessageType() {
        return NgapMessageType.RRCInactiveTransitionReport;
    }

    @Override
    public NgapProtocolIeType getProtocolIeType() {
        return NgapProtocolIeType.forMessage("RRCInactiveTransitionReport");
    }
    ...
    public Class<? extends NGAP_Value>[] getIeTypes() {
        return new Class[] { NGAP_AMF_UE_NGAP_ID.class, NGAP_RAN_UE_NGAP_ID.class, NGAP_RRCState.class, NGAP_UserLocationInformation.class };
    }
