...
import tr.havelsan.ueransim.ngap0.ies.sequences.NGAP_RANStatusTransfer_TransparentContainer;

public class NGAP_DownlinkRANStatusTransfer extends NGAP_BaseMessage {
    ...
    public NgapMessageType getMessageType() {
        return NgapMessageType.DownlinkRANStatusTransfer;
    }

    @Override
    public NgapProtocolIeType getProtocolIeType() {
        return NgapProtocolIeType.forMessage("DownlinkRANStatusTransfer");
    }
